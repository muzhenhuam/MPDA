function [auc_ABMean,auc_ABMode,...
    FARMean,FARMode,dtmapMean,dtmapMode,DetectionMode]=SkewTGlobalFunc(data,map,SkewCoeff,FiltOn,DAT)
...
if FiltOn==1 %stdfilt
    for Dim3=1:LA
        DataFiltered(:,:,Dim3)=stdfilt(data(:,:,Dim3)); %计算局部标准偏差
    end
